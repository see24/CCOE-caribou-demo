...
Table 2. Monitoring scenarios adapted from [@rettie_summary_2017]. *Anna will remove the last couple columns since we won't be varying those (same for min collars since it'll be the same as init collars)
```{r}
