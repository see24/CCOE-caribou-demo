...
We assume each group of animals in a calf:cow survey contains one or more collared adult females ($T$), and may also include: uncollared adult females misidentified as young bulls ($U$); correctly identified uncollared adult females ($V$); correctly identified young bulls ($O$); young bulls misidentified as uncollared adult females ($P$); observed calves ($J$); and unobserved calves ($K$). The apparent number of adult females in the group is $T+V+P=Tw$, where $w$ is a multiplier that defines the apparent number of adult females as a function of the number of collared animals. The ratio of young bulls to uncollared adult females in the group is:
$$q = \frac{P+O}{U+V}.$$
