...
```{r PriorAllFits, fig.cap="Differences between posterior distributions from the Bayesian model and simulated outcomes from the national model, assuming minimal monitoring (1 years of 1 collar per year) of populations from the 50% quantile of the national model. The multiplier on the prior standard deviation of the survival intercept ($\\beta^S_0$ in Table @ref(tab:priors)) is set to 5 in these examples.", cache=TRUE}
knitr::include_graphics(here::here("figs/SurvsQStarts1ssv0.01.png"))

```


```{r PriorHighFits, fig.cap="Differences between posterior distributions from the Bayesian model and simulated outcomes from the national model, assuming intensive monitoring (15 years of 300 collars per year) of populations from the 97.5% quantile of the national model. The multiplier on the prior standard deviation of the survival intercept ($\\beta^S_0$ in Table @ref(tab:priors)) is set to 5 in these examples.", cache=TRUE}
knitr::include_graphics(here::here("figs/SurvsQStarts300highlse5.png"))
